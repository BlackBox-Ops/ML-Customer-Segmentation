...
app = FastAPI(
    title="API Customer Segmentation dengan FCM",
    description="API untuk segmentasi pelanggan menggunakan Fuzzy C-Means",
    version="1.0"
)
...
try:
    ...
    gmm_model_path = "../models/cmeans model/cmeans_model.pkl"
...
if __name__ == "__main__":
    uvicorn.run("07_API_FCM:app", host="127.0.0.1", port=8000, log_level="info")